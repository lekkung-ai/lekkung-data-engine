...
COMMODITIES = {
    "BZ=F": {
        ...
        "unit": "USD/บาร์เรล",
        "zone": "energy",
        "tickers": ["PTTEP", "PTT", "TOP", "SPRC", "BCP", "AAV", "BA"],
        "ticker_impacts": {
            "PTTEP": "revenue",
            "PTT": "revenue",
            "TOP": "margin",
    ...
    "HO=F": {
        ...
        "unit": "USD/แกลลอน",
        "zone": "energy",
        "tickers": ["TOP", "SPRC", "BCP", "IRPC", "KEX", "SJWD", "III"],
        "ticker_impacts": {
            "TOP": "revenue",
            "SPRC": "revenue",
            "BCP": "revenue",
    ...
    "SB=F": {
        ...
        "unit": "เซนต์/ปอนด์",
        "zone": "agri",
        "tickers": ["KSL", "KTIS", "KBS", "BRR", "CBG", "OSP", "ICHI", "SAPPE", "SNNP"],
        "ticker_impacts": {
            "KSL": "revenue",
            "KTIS": "revenue",
            "KBS": "revenue",
    ...
    "THB=X": {
        ...
        "name_en": "USD/THB (ค่าขึ้น = บาทอ่อน)",
        "unit": "บาท/ดอลลาร์",
        "zone": "financial",
        "tickers": ["DELTA", "KCE", "HANA", "TU", "ITC", "AOT"],
        "ticker_impacts": {
            "DELTA": "revenue",
            "KCE": "revenue",
            "HANA": "revenue",
    ...
    "^TNX": {
        ...
        "unit": "%",
        "zone": "financial",
        "tickers": ["TLI", "BLA", "KBANK", "BBL", "SCB", "MTC", "SAWAD", "TIDLOR"],
        "ticker_impacts": {
            "TLI": "revenue",
            "BLA": "revenue",
            "KBANK": "revenue",
